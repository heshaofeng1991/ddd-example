...
type ClientInterface interface {
	...
	GetOrderDetail(ctx context.Context, orderId int, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetOrderDetail(ctx context.Context, orderId int, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetOrderDetailRequest(c.Server, orderId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetOrderDetailRequest generates requests for GetOrderDetail
func NewGetOrderDetailRequest(server string, orderId int) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetOrderDetail request
	GetOrderDetailWithResponse(ctx context.Context, orderId int, reqEditors ...RequestEditorFn) (*GetOrderDetailResponse, error)
}
...
// Status returns HTTPResponse.Status
func (r GetOrderDetailResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetOrderDetailResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetOrderDetailWithResponse request returning *GetOrderDetailResponse
func (c *ClientWithResponses) GetOrderDetailWithResponse(ctx context.Context, orderId int, reqEditors ...RequestEditorFn) (*GetOrderDetailResponse, error) {
	rsp, err := c.GetOrderDetail(ctx, orderId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetOrderDetailResponse(rsp)
}
...
// ParseGetOrderDetailResponse parses an HTTP response from a GetOrderDetailWithResponse call
func ParseGetOrderDetailResponse(rsp *http.Response) (*GetOrderDetailResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
